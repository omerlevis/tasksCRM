<template>
    <div class="col-12 center">
        ...
        >
            ...
            <template #thead>
                <vs-tr>
                    ...
                    <vs-th sort @click="users = $vs.sortData($event ,users, 'website')">
                        Website
                    </vs-th>
            ...
            <template #tbody>
                ...
                >
                    ...
                    <vs-td edit @click="edit = tr, editProp = 'website', editActive = true">
                        {{ tr.website }}
                    </vs-td>
                    <vs-td>
                        {{ tr.id }}
        ...
        <vs-dialog v-model="editActive">
            ...
            <vs-input @keypress.enter="editActive = false" v-if="editProp == 'website'" v-model="edit[editProp]" />
        </vs-dialog>
    </div>
</template>
